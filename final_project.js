...
function Main (){
  ...
  document.getElementById("intro1").setAttribute("style","display:block;")
  ...
  document.getElementById("Sad").setAttribute("style","display:none;")
  document.getElementById("Sad1").setAttribute("style","display:none;")
  document.getElementById("Sad2").setAttribute("style","display:none;")
  document.getElementById("Sad3").setAttribute("style","display:none;")
  document.getElementById("Happy").setAttribute("style","display:none;")
  document.getElementById("Happy1").setAttribute("style","display:none;")
  document.getElementById("Happy2").setAttribute("style","display:none;")
  document.getElementById("Happy3").setAttribute("style","display:none;")
  document.getElementById("Normal").setAttribute("style","display:none;")
  document.getElementById("Normal1").setAttribute("style","display:none;")
  document.getElementById("Normal2").setAttribute("style","display:none;")
  document.getElementById("Normal3").setAttribute("style","display:none;")
...
function Sad (){
  ...
  document.getElementById("title3").setAttribute("style","display:none;")
  document.getElementById("title4").setAttribute("style","display:none;")
  document.getElementById("intro1").setAttribute("style","display:none;")
  ...
  document.getElementById("Sad").setAttribute("style","display:block;")
  document.getElementById("Sad1").setAttribute("style","display:block;")
  document.getElementById("Sad2").setAttribute("style","display:block;")
  document.getElementById("Sad3").setAttribute("style","display:block;")
  document.getElementById("Sad").setAttribute("style","color:blue;")
  document.getElementById("Happy").setAttribute("style","display:none;")
  document.getElementById("Happy1").setAttribute("style","display:none;")
  document.getElementById("Happy2").setAttribute("style","display:none;")
  document.getElementById("Happy3").setAttribute("style","display:none;")
...
function Happy (){
  ...
  document.getElementById("Sad2").setAttribute("style","display:none;")
  document.getElementById("Sad3").setAttribute("style","display:none;")
  document.getElementById("Happy").setAttribute("style","display:block;")
  document.getElementById("Happy1").setAttribute("style","display:block;")
  document.getElementById("Happy2").setAttribute("style","display:block;")
  document.getElementById("Happy3").setAttribute("style","display:block;")
  document.getElementById("Normal").setAttribute("style","display:none;")
  document.getElementById("Normal1").setAttribute("style","display:none;")
  document.getElementById("Normal2").setAttribute("style","display:none;")
  document.getElementById("Normal3").setAttribute("style","display:none;")
...
function Normal () {
  ...
  document.getElementById("Normal1").setAttribute("style","display:block;")
  document.getElementById("Normal2").setAttribute("style","display:block;")
  document.getElementById("Normal3").setAttribute("style","display:block;")
  document.getElementById("Normal").setAttribute("style","color:white")
  }
